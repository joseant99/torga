...
describe('Service Tests', () => {
    describe('Municipios Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new Municipios(0, 'AAAAAAA');
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should create a Municipios', async () => {
            ...
            it('should update a Municipios', async () => {
                const returnedFromService = Object.assign(
                    {
                        nombre: 'BBBBBB'
                    },
            ...
            it('should return a list of Municipios', async () => {
                const returnedFromService = Object.assign(
                    {
                        nombre: 'BBBBBB'
                    },
            ...
            it('should delete a Municipios', async () => {
