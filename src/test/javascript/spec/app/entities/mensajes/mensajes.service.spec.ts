...
describe('Service Tests', () => {
    describe('Mensajes Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new Mensajes(0, 'AAAAAAA', 'image/png', 'AAAAAAA', 'AAAAAAA');
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should create a Mensajes', async () => {
            ...
            it('should update a Mensajes', async () => {
                const returnedFromService = Object.assign(
                    {
                        texto: 'BBBBBB',
                        imagen: 'BBBBBB',
            ...
            it('should return a list of Mensajes', async () => {
                const returnedFromService = Object.assign(
                    {
                        texto: 'BBBBBB',
                        imagen: 'BBBBBB',
            ...
            it('should delete a Mensajes', async () => {
