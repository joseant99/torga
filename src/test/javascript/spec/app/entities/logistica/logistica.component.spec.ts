...
import { LogisticaComponent } from 'app/entities/logistica/logistica.component';
...
describe('Component Tests', () => {
    describe('Logistica Management Component', () => {
        let comp: LogisticaComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(LogisticaComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.logisticas[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
