...
import { ArmarioComponent } from 'app/entities/armario/armario.component';
import { ArmarioService } from 'app/entities/armario/armario.service';
import { Armario } from 'app/shared/model/armario.model';

describe('Component Tests', () => {
    describe('Armario Management Component', () => {
        let comp: ArmarioComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(ArmarioComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.armarios[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
