...
import { FPagoComponent } from 'app/entities/f-pago/f-pago.component';
import { FPagoService } from 'app/entities/f-pago/f-pago.service';
import { FPago } from 'app/shared/model/f-pago.model';

describe('Component Tests', () => {
    describe('FPago Management Component', () => {
        let comp: FPagoComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(FPagoComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.fPagos[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
