...
import { VendedoresComponent } from 'app/entities/vendedores/vendedores.component';
...
describe('Component Tests', () => {
    describe('Vendedores Management Component', () => {
        let comp: VendedoresComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(VendedoresComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.vendedores[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
