...
import { InterioresComponent } from 'app/entities/interiores/interiores.component';
...
describe('Component Tests', () => {
    describe('Interiores Management Component', () => {
        let comp: InterioresComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(InterioresComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.interiores[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
