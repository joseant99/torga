...
import { DatosClienteComponent } from 'app/entities/datos-cliente/datos-cliente.component';
...
describe('Component Tests', () => {
    describe('DatosCliente Management Component', () => {
        let comp: DatosClienteComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(DatosClienteComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.datosClientes[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
