...
import { UsbComponent } from 'app/entities/usb/usb.component';
import { UsbService } from 'app/entities/usb/usb.service';
import { Usb } from 'app/shared/model/usb.model';

describe('Component Tests', () => {
    describe('Usb Management Component', () => {
        let comp: UsbComponent;
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.usbs[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
