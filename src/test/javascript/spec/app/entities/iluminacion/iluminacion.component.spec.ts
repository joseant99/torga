...
import { IluminacionComponent } from 'app/entities/iluminacion/iluminacion.component';
...
describe('Component Tests', () => {
    describe('Iluminacion Management Component', () => {
        let comp: IluminacionComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(IluminacionComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.iluminacions[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
