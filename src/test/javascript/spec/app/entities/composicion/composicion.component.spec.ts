...
import { ComposicionComponent } from 'app/entities/composicion/composicion.component';
...
describe('Component Tests', () => {
    describe('Composicion Management Component', () => {
        let comp: ComposicionComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [ComposicionComponent],
                providers: [
                    {
                ...
                .overrideTemplate(ComposicionComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.composicions[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
