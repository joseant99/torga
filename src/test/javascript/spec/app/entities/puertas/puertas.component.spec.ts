...
import { PuertasComponent } from 'app/entities/puertas/puertas.component';
import { PuertasService } from 'app/entities/puertas/puertas.service';
import { Puertas } from 'app/shared/model/puertas.model';

describe('Component Tests', () => {
    describe('Puertas Management Component', () => {
        let comp: PuertasComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(PuertasComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.puertas[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
