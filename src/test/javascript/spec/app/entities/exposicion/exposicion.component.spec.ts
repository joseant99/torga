...
import { ExposicionComponent } from 'app/entities/exposicion/exposicion.component';
...
describe('Component Tests', () => {
    describe('Exposicion Management Component', () => {
        let comp: ExposicionComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(ExposicionComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.exposicions[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
