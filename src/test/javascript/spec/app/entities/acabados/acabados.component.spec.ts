...
import { AcabadosComponent } from 'app/entities/acabados/acabados.component';
...
describe('Component Tests', () => {
    describe('Acabados Management Component', () => {
        let comp: AcabadosComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(AcabadosComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.acabados[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
