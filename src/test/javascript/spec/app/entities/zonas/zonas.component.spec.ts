...
import { ZonasComponent } from 'app/entities/zonas/zonas.component';
import { ZonasService } from 'app/entities/zonas/zonas.service';
import { Zonas } from 'app/shared/model/zonas.model';

describe('Component Tests', () => {
    describe('Zonas Management Component', () => {
        let comp: ZonasComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(ZonasComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.zonas[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
