...
public class ProductosDormitorioResource {
    ...
    @GetMapping("/productos-dormitorios-categoria13/{id}")
    @Timed
    public ResponseEntity<Collection<ProductosDormitorio>> getProductosDormitoriosCategoria13(@PathVariable Long id) {
        Collection<ProductosDormitorio> page =  (Collection<ProductosDormitorio>) productosDormitorioQueryService.findByCategoriaDormi13(id);
        return ResponseEntity.ok().body(page);
    }
    
    @GetMapping("/productos-dormitorios-categoria14/{id}")
    @Timed
    public ResponseEntity<Collection<ProductosDormitorio>> getProductosDormitoriosCategoria14(@PathVariable Long id) {
        Collection<ProductosDormitorio> page =  (Collection<ProductosDormitorio>) productosDormitorioQueryService.findByCategoriaDormi14(id);
        return ResponseEntity.ok().body(page);
    }
    
    @GetMapping("/productos-dormitorios-categoria15/{id}")
    @Timed
    public ResponseEntity<Collection<ProductosDormitorio>> getProductosDormitoriosCategoria15(@PathVariable Long id) {
        Collection<ProductosDormitorio> page =  (Collection<ProductosDormitorio>) productosDormitorioQueryService.findByCategoriaDormi15(id);
        return ResponseEntity.ok().body(page);
    }
    ...
    public ResponseEntity<Collection<ProductosDormitorio>> getProductosDormitoriosCategoria1(@PathVariable Long id) {
        Collection<ProductosDormitorio> page =  (Collection<ProductosDormitorio>) productosDormitorioQueryService.findByCategoria1(id);
        return ResponseEntity.ok().body(page);
    }
    /**
