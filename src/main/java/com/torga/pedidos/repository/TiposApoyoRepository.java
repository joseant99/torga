...
public interface TiposApoyoRepository extends JpaRepository<TiposApoyo, Long> {
	...
	@Query("SELECT u FROM TiposApoyo u WHERE  u.productoApoyo.id = ?1 and u.ancho>= ?2 and (u.id <61 or u.id>113) and(u.nombre = 'bancada 35' or u.nombre = 'bancada 45' or u.nombre = 'bancada 55' or u.nombre = 'bancada 65' or u.nombre = 'bancada 42.5' or u.nombre = 'bancada 52.5' or u.nombre = 'bancada 62.5' or u.nombre = 'bancada 72.5' or u.nombre = 'Colgado' or u.nombre = 'Patas Regulable menos 150' or u.nombre = 'Patas Regulable mayor 150' or u.nombre = 'Patas metalicas menor 175 fondo 44' or u.nombre = 'Patas metalicas mayor 175 fondo 44') order by u.ancho")
