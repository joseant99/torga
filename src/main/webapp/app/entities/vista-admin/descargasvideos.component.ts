...
@Component({
    ...
    selector: 'jhi-inicio',
    templateUrl: './descargasvideos.component.html'
})
export class descargasvideosComponent implements OnInit, AfterViewInit {
    account: Account;
    currentAccount: any;
    ...
    ngOnInit() {
        ...
        this.navbarComponent.fecha_entregaService
            .query({
                size: 100000
            })
            .subscribe(data => {
