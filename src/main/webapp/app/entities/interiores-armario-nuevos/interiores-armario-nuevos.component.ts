...
@Component({
    ...
    templateUrl: './interiores-armario-nuevos.component.html'
})
export class InterioresArmarioNuevosComponent implements OnInit, OnDestroy {
    currentAccount: any;
    ...
    transition() {
        this.router.navigate(['/interiores-armario-nuevos'], {
            queryParams: {
                page: this.page,
                size: this.itemsPerPage,
    ...
    ngOnInit() {
        ...
        this.registerChangeInInterioresArmarioNuevos();
    }
    ...
    trackId(index: number, item: IInterioresArmarioNuevos) {
        return item.id;
    }

    registerChangeInInterioresArmarioNuevos() {
        this.eventSubscriber = this.eventManager.subscribe('interioresArmarioNuevosListModification', response => this.loadAll());
    }
    ...
    protected paginateInterioresArmarioNuevos(data: IInterioresArmarioNuevos[], headers: HttpHeaders) {
        this.links = this.parseLinks.parse(headers.get('link'));
        this.totalItems = parseInt(headers.get('X-Total-Count'), 10);
        this.queryCount = this.totalItems;
        this.interioresArmarioNuevos = data;
    }
