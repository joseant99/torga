...
export class ProvinciasComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.provinciasService
            ...
            .subscribe(
                (res: HttpResponse<IProvincias[]>) => this.paginateProvincias(res.body, res.headers),
    ...
    trackId(index: number, item: IProvincias) {
        return item.id;
    }

    registerChangeInProvincias() {
        this.eventSubscriber = this.eventManager.subscribe('provinciasListModification', response => this.loadAll());
    }
    ...
    protected paginateProvincias(data: IProvincias[], headers: HttpHeaders) {
