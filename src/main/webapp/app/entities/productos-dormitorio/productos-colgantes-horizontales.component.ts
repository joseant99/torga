...
@Component({
    ...
    templateUrl: './productos-colgantes-horizontales.component.html'
})
export class ProductosColgantesHorizontalesComponent implements OnInit, OnDestroy {
    currentAccount: any;
    ...
    public borrarProdCalculadora() {
        ...
        $('.productosColor184').removeAttr('style');
        $('.productosColor185').removeAttr('style');
        $('.productosColor186').removeAttr('style');
        $('.productosColor187').removeAttr('style');
        $('.productosColor188').removeAttr('style');
        $('.productosColor189').removeAttr('style');
        $('.productosColor190').removeAttr('style');
        $('.productosColor191').removeAttr('style');
        $('.productosColor192').removeAttr('style');
        $('.productosColor193').removeAttr('style');
        $('.productosColor194').removeAttr('style');
        $('.productosColor195').removeAttr('style');
        $('.productosColor196').removeAttr('style');
        $('.productosColor197').removeAttr('style');
        $('.productosColor198').removeAttr('style');
        $('.productosColor199').removeAttr('style');
        $('.productosColor200').removeAttr('style');
        $('.productosColor201').removeAttr('style');
        $('.productosColor202').removeAttr('style');
        $('.productosColor203').removeAttr('style');

        $('.productosColorSolo184').removeAttr('style');
        $('.productosColorSolo185').removeAttr('style');
        $('.productosColorSolo186').removeAttr('style');
        $('.productosColorSolo187').removeAttr('style');
        $('.productosColorSolo188').removeAttr('style');
        $('.productosColorSolo189').removeAttr('style');
        $('.productosColorSolo190').removeAttr('style');
        $('.productosColorSolo191').removeAttr('style');
        $('.productosColorSolo192').removeAttr('style');
        $('.productosColorSolo193').removeAttr('style');
        $('.productosColorSolo194').removeAttr('style');
        $('.productosColorSolo195').removeAttr('style');
        $('.productosColorSolo196').removeAttr('style');
        $('.productosColorSolo197').removeAttr('style');
        $('.productosColorSolo198').removeAttr('style');
        $('.productosColorSolo199').removeAttr('style');
        $('.productosColorSolo200').removeAttr('style');
        $('.productosColorSolo201').removeAttr('style');
        $('.productosColorSolo202').removeAttr('style');
        $('.productosColorSolo203').removeAttr('style');

        $('.productosColor184').css({ 'background-color': 'white' });
        $('.productosColor185').css({ 'background-color': 'white' });
        $('.productosColor186').css({ 'background-color': 'white' });
        $('.productosColor187').css({ 'background-color': 'white' });
        $('.productosColor188').css({ 'background-color': 'white' });
        $('.productosColor189').css({ 'background-color': 'white' });
        $('.productosColor190').css({ 'background-color': 'white' });
        $('.productosColor191').css({ 'background-color': 'white' });
        $('.productosColor192').css({ 'background-color': 'white' });
        $('.productosColor193').css({ 'background-color': 'white' });
        $('.productosColor194').css({ 'background-color': 'white' });
        $('.productosColor195').css({ 'background-color': 'white' });
        $('.productosColor196').css({ 'background-color': 'white' });
        $('.productosColor197').css({ 'background-color': 'white' });
        $('.productosColor198').css({ 'background-color': 'white' });
        $('.productosColor199').css({ 'background-color': 'white' });
        $('.productosColor200').css({ 'background-color': 'white' });
        $('.productosColor201').css({ 'background-color': 'white' });
        $('.productosColor202').css({ 'background-color': 'white' });
        $('.productosColor203').css({ 'background-color': 'white' });

        $('.productosColor184 #acabados').css({ display: 'none' });
        $('.productosColor185 #acabados').css({ display: 'none' });
        $('.productosColor186 #acabados').css({ display: 'none' });
        $('.productosColor187 #acabados').css({ display: 'none' });
        $('.productosColor188 #acabados').css({ display: 'none' });
        $('.productosColor189 #acabados').css({ display: 'none' });
        $('.productosColor190 #acabados').css({ display: 'none' });
        $('.productosColor191 #acabados').css({ display: 'none' });
        $('.productosColor192 #acabados').css({ display: 'none' });
        $('.productosColor193 #acabados').css({ display: 'none' });
        $('.productosColor194 #acabados').css({ display: 'none' });
        $('.productosColor195 #acabados').css({ display: 'none' });
        $('.productosColor196 #acabados').css({ display: 'none' });
        $('.productosColor197 #acabados').css({ display: 'none' });
        $('.productosColor198 #acabados').css({ display: 'none' });
        $('.productosColor199 #acabados').css({ display: 'none' });
        $('.productosColor200 #acabados').css({ display: 'none' });
        $('.productosColor201 #acabados').css({ display: 'none' });
        $('.productosColor202 #acabados').css({ display: 'none' });
        $('.productosColor203 #acabados').css({ display: 'none' });

        $('.productosColor184 #dimensiones').css({ display: 'none' });
        $('.productosColor185 #dimensiones').css({ display: 'none' });
        $('.productosColor186 #dimensiones').css({ display: 'none' });
        $('.productosColor187 #dimensiones').css({ display: 'none' });
        $('.productosColor188 #dimensiones').css({ display: 'none' });
        $('.productosColor189 #dimensiones').css({ display: 'none' });
        $('.productosColor190 #dimensiones').css({ display: 'none' });
        $('.productosColor191 #dimensiones').css({ display: 'none' });
        $('.productosColor192 #dimensiones').css({ display: 'none' });
        $('.productosColor193 #dimensiones').css({ display: 'none' });
        $('.productosColor194 #dimensiones').css({ display: 'none' });
        $('.productosColor195 #dimensiones').css({ display: 'none' });
        $('.productosColor196 #dimensiones').css({ display: 'none' });
        $('.productosColor197 #dimensiones').css({ display: 'none' });
        $('.productosColor198 #dimensiones').css({ display: 'none' });
        $('.productosColor199 #dimensiones').css({ display: 'none' });
        $('.productosColor200 #dimensiones').css({ display: 'none' });
        $('.productosColor201 #dimensiones').css({ display: 'none' });
        $('.productosColor202 #dimensiones').css({ display: 'none' });
        $('.productosColor203 #dimensiones').css({ display: 'none' });
    ...
    public open(producto, productoNombre) {
        ...
        if (arrayComprobar[producto] == undefined) {
            ...
            if (producto == 184) {
                arrayComprobar[185] = undefined;
                arrayComprobar[186] = undefined;
                arrayComprobar[187] = undefined;
                arrayComprobar[188] = undefined;
                arrayComprobar[189] = undefined;
                arrayComprobar[190] = undefined;
                arrayComprobar[191] = undefined;
                arrayComprobar[192] = undefined;
                arrayComprobar[193] = undefined;
                arrayComprobar[194] = undefined;
                arrayComprobar[195] = undefined;
                arrayComprobar[196] = undefined;
                arrayComprobar[197] = undefined;
                arrayComprobar[198] = undefined;
                arrayComprobar[199] = undefined;
                arrayComprobar[200] = undefined;
                arrayComprobar[201] = undefined;
                arrayComprobar[202] = undefined;
                arrayComprobar[203] = undefined;
            }

            if (producto == 185) {
                arrayComprobar[184] = undefined;
                arrayComprobar[186] = undefined;
                arrayComprobar[187] = undefined;
                arrayComprobar[188] = undefined;
                arrayComprobar[189] = undefined;
                ...
                for (let i = 0; i < datos.length; i++) {
                    if (producto == datos[i]['productosDormitorio']['id']) {
                        ...
                        if (cont == 1 && datos[i]['mensaje'] != 'Medidas Especiales') {
                            ...
                            $('.productosColor' + producto + ' .dimensionesColor2').css({ float: 'left' });
                        ...
                        if (cont == 2 && datos[i]['mensaje'] != 'Medidas Especiales') {
                            ...
                            $('.productosColor' + producto + ' .dimensionesColor3').css({ float: 'left' });
                        ...
                        if (cont == 3 && datos[i]['mensaje'] != 'Medidas Especiales') {
                            ...
                            $('.productosColor' + producto + ' .dimensionesColor4').css({ float: 'left' });
                        ...
                        if (cont == 4 && datos[i]['mensaje'] != 'Medidas Especiales') {
                            ...
                            $('.productosColor' + producto + ' .dimensionesColor5').css({ float: 'left' });
                        ...
                        if (cont == 5 && datos[i]['mensaje'] != 'Medidas Especiales') {
                            ...
                            $('.productosColor' + producto + ' .dimensionesColor6').css({ float: 'left' });
            ...
            if (producto == 184) {
                $('.productosColor184').css({ 'margin-bottom': '650px' });
            }
            if (producto == 185) {
                $('.productosColor185').css({ 'margin-bottom': '650px' });
            }
            if (producto == 186 || producto == 187) {
                $('.productosColor186').css({ 'margin-bottom': '650px' });
                $('.productosColor187').css({ 'margin-bottom': '650px' });
            }
            if (producto == 188 || producto == 189) {
                $('.productosColor188').css({ 'margin-bottom': '650px' });
                $('.productosColor189').css({ 'margin-bottom': '650px' });
            }
            if (producto == 190 || producto == 191) {
                $('.productosColor190').css({ 'margin-bottom': '650px' });
                $('.productosColor191').css({ 'margin-bottom': '650px' });
            }
            if (producto == 192 || producto == 193) {
                $('.productosColor192').css({ 'margin-bottom': '650px' });
                $('.productosColor193').css({ 'margin-bottom': '650px' });
            }
            if (producto == 194 || producto == 195) {
                $('.productosColor194').css({ 'margin-bottom': '650px' });
                $('.productosColor195').css({ 'margin-bottom': '650px' });
            }
            if (producto == 196 || producto == 197) {
                $('.productosColor196').css({ 'margin-bottom': '650px' });
                $('.productosColor197').css({ 'margin-bottom': '650px' });
            }
            if (producto == 198 || producto == 199) {
                $('.productosColor198').css({ 'margin-bottom': '650px' });
                $('.productosColor199').css({ 'margin-bottom': '650px' });
            }
            if (producto == 200 || producto == 201) {
                $('.productosColor200').css({ 'margin-bottom': '650px' });
                $('.productosColor201').css({ 'margin-bottom': '650px' });
            }
            if (producto == 202) {
                $('.productosColor202').css({ 'margin-bottom': '650px' });
            }
            if (producto == 203) {
                $('.productosColor203').css({ 'margin-bottom': '650px' });
            }
    ...
    public dimensionesCogidas(id) {
        ...
        if (acaSi == 0) {
            ...
            if (idProd1 == 184) {
                $('.productosColor184').css({ 'margin-bottom': '1130px' });
            }
            if (idProd1 == 185) {
                $('.productosColor185').css({ 'margin-bottom': '1130px' });
            }
            if (idProd1 == 186 || idProd1 == 187) {
                $('.productosColor186').css({ 'margin-bottom': '1130px' });
                $('.productosColor187').css({ 'margin-bottom': '1130px' });
            }
            if (idProd1 == 188 || idProd1 == 189) {
                $('.productosColor188').css({ 'margin-bottom': '1130px' });
                $('.productosColor189').css({ 'margin-bottom': '1130px' });
            }
            if (idProd1 == 190 || idProd1 == 191) {
                $('.productosColor190').css({ 'margin-bottom': '1130px' });
                $('.productosColor191').css({ 'margin-bottom': '1130px' });
            }
            if (idProd1 == 192 || idProd1 == 193) {
                $('.productosColor192').css({ 'margin-bottom': '1130px' });
                $('.productosColor193').css({ 'margin-bottom': '1130px' });
            }
            if (idProd1 == 194 || idProd1 == 195) {
                $('.productosColor194').css({ 'margin-bottom': '1130px' });
                $('.productosColor195').css({ 'margin-bottom': '1130px' });
            }
            if (idProd1 == 196 || idProd1 == 197) {
                $('.productosColor196').css({ 'margin-bottom': '1130px' });
                $('.productosColor197').css({ 'margin-bottom': '1130px' });
            }
            if (idProd1 == 198 || idProd1 == 199) {
                $('.productosColor198').css({ 'margin-bottom': '1130px' });
                $('.productosColor199').css({ 'margin-bottom': '1130px' });
            }
            if (idProd1 == 200 || idProd1 == 201) {
                $('.productosColor200').css({ 'margin-bottom': '1130px' });
                $('.productosColor201').css({ 'margin-bottom': '1130px' });
            }
            if (idProd1 == 202) {
                $('.productosColor202').css({ 'margin-bottom': '1130px' });
            }
            if (idProd1 == 203) {
                $('.productosColor203').css({ 'margin-bottom': '1130px' });
            }
    ...
    loadAll() {
        ...
        if (todos != undefined) {
            ...
            this.productosDormitorioService.categoria(18).subscribe(data => {
    ...
    ngOnInit() {
        ...
        this.precioTiendaProductosService.findProdId(18, tienda.id).subscribe(data => {
