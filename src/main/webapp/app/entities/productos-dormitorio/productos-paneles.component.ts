...
@Component({
    ...
    templateUrl: './productos-paneles.component.html'
})
export class ProductosPanelesComponent implements OnInit, OnDestroy {
    currentAccount: any;
    ...
    public open(producto, productoNombre) {
        ...
        if (arrayComprobar[producto] == undefined) {
            ...
            if (producto == 207) {
                arrayComprobar[208] = undefined;
                arrayComprobar[209] = undefined;
                arrayComprobar[210] = undefined;
                arrayComprobar[211] = undefined;
            }
            if (producto == 208) {
                arrayComprobar[207] = undefined;
                arrayComprobar[209] = undefined;
                arrayComprobar[210] = undefined;
                arrayComprobar[211] = undefined;
            }
            ...
            if (producto == 207) {
                $('.productosColor207').css({ 'margin-bottom': '650px' });
            }
            if (producto == 208) {
                $('.productosColor208').css({ 'margin-bottom': '650px' });
            }
            if (producto == 209) {
                $('.productosColor209').css({ 'margin-bottom': '650px' });
            }
            if (producto == 210) {
                $('.productosColor210').css({ 'margin-bottom': '650px' });
            }
            if (producto == 211) {
                $('.productosColor211').css({ 'margin-bottom': '650px' });
            }
    ...
    loadAll() {
        ...
        if (todos != undefined) {
            ...
            this.productosDormitorioService.categoria(21).subscribe(data => {
    ...
    ngOnInit() {
        ...
        this.precioTiendaProductosService.findProdId(21, tienda.id).subscribe(data => {
