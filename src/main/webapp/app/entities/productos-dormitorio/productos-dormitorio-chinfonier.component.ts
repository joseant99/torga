...
@Component({
    ...
    templateUrl: './productos-dormitorio-chinfonier.component.html'
})
export class ProductosDormitorioChinfonierComponent implements OnInit, OnDestroy {
    currentAccount: any;
    ...
    public borrarProdCalculadora() {
        ...
        $('.productosColorSin238').css({ 'background-color': 'white' });
        $('.productosColorSin239').css({ 'background-color': 'white' });
        $('.productosColorSin240').css({ 'background-color': 'white' });
        $('.productosColorSin241').css({ 'background-color': 'white' });

        $('.productosColorSin238 #acabados').css({ display: 'none' });
        $('.productosColorSin239 #acabados').css({ display: 'none' });
        $('.productosColorSin240 #acabados').css({ display: 'none' });
        $('.productosColorSin241 #acabados').css({ display: 'none' });

        $('.productosColorSin238 #dimensiones').css({ display: 'none' });
        $('.productosColorSin239 #dimensiones').css({ display: 'none' });
        $('.productosColorSin240 #dimensiones').css({ display: 'none' });
        $('.productosColorSin241 #dimensiones').css({ display: 'none' });
        ...
        $('.productosColorSin238').removeAttr('style');
        $('.productosColorSin239').removeAttr('style');
        $('.productosColorSin240').removeAttr('style');
        $('.productosColorSin241').removeAttr('style');

        $('.productosColorSolo238').removeAttr('style');
        $('.productosColorSolo239').removeAttr('style');
        $('.productosColorSolo240').removeAttr('style');
        $('.productosColorSolo241').removeAttr('style');
    ...
    public open(producto, productoNombre) {
        ...
        if (arrayComprobar[producto] == undefined) {
            ...
            if (producto == 238) {
                arrayComprobar[239] = undefined;
                arrayComprobar[240] = undefined;
                arrayComprobar[241] = undefined;
            }
            if (producto == 239) {
                arrayComprobar[238] = undefined;
                arrayComprobar[240] = undefined;
                arrayComprobar[241] = undefined;
            }
            if (producto == 240) {
    ...
    public dimensionesCogidas(id) {
        ...
        if (acaSi == 0) {
            ...
            $('.productosColor238 #acabados').css({ display: 'none' });
            $('.productosColor239 #acabados').css({ display: 'none' });
            $('.productosColor240 #acabados').css({ display: 'none' });
            $('.productosColor241 #acabados').css({ display: 'none' });
    ...
    loadAll() {
        ...
        if (todos != undefined) {
            ...
            this.productosDormitorioService.categoria(3).subscribe(data => {
    ...
    ngOnInit() {
        ...
        this.precioTiendaProductosService.findProdId(3, tienda.id).subscribe(data => {
