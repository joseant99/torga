...
@Component({
    ...
    templateUrl: './productos-comoda.component.html'
})
export class ProductosComodaComponent implements OnInit, OnDestroy {
    currentAccount: any;
    ...
    public borrarProdCalculadora() {
        ...
        $('.productosColor242').css({ 'background-color': 'white' });
        ...
        $('.productosColor242 #dimensiones').css({ display: 'none' });
    ...
    loadAll() {
        ...
        if (todos != undefined) {
            ...
            this.productosDormitorioService.categoria(26).subscribe(data => {
    ...
    ngOnInit() {
        ...
        this.precioTiendaProductosService.findProdId(26, tienda.id).subscribe(data => {
