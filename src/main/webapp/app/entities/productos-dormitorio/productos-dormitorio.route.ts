...
import { ProductosShapediverComponent } from './productos-shapediver.component';
...
export const productosDormitorioRoute: Routes = [
    ...
    {
        path: 'rincon-dormitorio',
        component: RinconDormitorioComponent,
        resolve: {
            pagingParams: JhiResolvePagingParams
        },
        data: {
    ...
    {
        path: 'productos-shapediver',
        component: ProductosShapediverComponent,
        resolve: {
            pagingParams: JhiResolvePagingParams
        },
        data: {
