...
export class ProductosDormitorioCategoriaComponent implements OnInit, OnDestroy {
    currentAccount: any;
    ...
    public borrarProdCalculadora() {
        ...
        $('.productosColor1 #acabados').css({ display: 'none' });
        $('.productosColor2 #acabados').css({ display: 'none' });
        $('.productosColor3 #acabados').css({ display: 'none' });
        $('.productosColor4 #acabados').css({ display: 'none' });
        $('.productosColor5 #acabados').css({ display: 'none' });
        $('.productosColor6 #acabados').css({ display: 'none' });
        $('.productosColor7 #acabados').css({ display: 'none' });
        $('.productosColor8 #acabados').css({ display: 'none' });
        $('.productosColor9 #acabados').css({ display: 'none' });
        $('.productosColor10 #acabados').css({ display: 'none' });
        $('.productosColor11 #acabados').css({ display: 'none' });
        $('.productosColor12 #acabados').css({ display: 'none' });
        $('.productosColor13 #acabados').css({ display: 'none' });
        $('.productosColor229 #acabados').css({ display: 'none' });

        $('.productosColor1 #dimensiones').css({ display: 'none' });
        $('.productosColor2 #dimensiones').css({ display: 'none' });
        $('.productosColor3 #dimensiones').css({ display: 'none' });
        $('.productosColor4 #dimensiones').css({ display: 'none' });
        $('.productosColor5 #dimensiones').css({ display: 'none' });
        $('.productosColor6 #dimensiones').css({ display: 'none' });
        $('.productosColor7 #dimensiones').css({ display: 'none' });
        $('.productosColor8 #dimensiones').css({ display: 'none' });
        $('.productosColor9 #dimensiones').css({ display: 'none' });
        $('.productosColor10 #dimensiones').css({ display: 'none' });
        $('.productosColor11 #dimensiones').css({ display: 'none' });
        $('.productosColor12 #dimensiones').css({ display: 'none' });
        $('.productosColor13 #dimensiones').css({ display: 'none' });
        $('.productosColor229 #dimensiones').css({ display: 'none' });
        ...
        $('.productosColor1').removeAttr('style');
        $('.productosColor2').removeAttr('style');
        $('.productosColor3').removeAttr('style');
        $('.productosColor4').removeAttr('style');
        $('.productosColor5').removeAttr('style');
        $('.productosColor6').removeAttr('style');
        $('.productosColor7').removeAttr('style');
        $('.productosColor8').removeAttr('style');
        $('.productosColor9').removeAttr('style');
        $('.productosColor10').removeAttr('style');
        $('.productosColor11').removeAttr('style');
        $('.productosColor12').removeAttr('style');
        $('.productosColor13').removeAttr('style');
        $('.productosColor229').removeAttr('style');
        $('.productosColorSolo1').removeAttr('style');
        $('.productosColorSolo2').removeAttr('style');
        $('.productosColorSolo3').removeAttr('style');
        $('.productosColorSolo4').removeAttr('style');
        $('.productosColorSolo5').removeAttr('style');
        $('.productosColorSolo6').removeAttr('style');
        $('.productosColorSolo7').removeAttr('style');
        $('.productosColorSolo8').removeAttr('style');
        $('.productosColorSolo9').removeAttr('style');
        $('.productosColorSolo10').removeAttr('style');
        $('.productosColorSolo11').removeAttr('style');
        $('.productosColorSolo12').removeAttr('style');
        $('.productosColorSolo13').removeAttr('style');
        $('.productosColorSolo229').removeAttr('style');
        $('.productosColor1').css({ 'background-color': 'white' });
        $('.productosColor2').css({ 'background-color': 'white' });
        $('.productosColor3').css({ 'background-color': 'white' });
        $('.productosColor4').css({ 'background-color': 'white' });
        $('.productosColor5').css({ 'background-color': 'white' });
        $('.productosColor6').css({ 'background-color': 'white' });
        $('.productosColor7').css({ 'background-color': 'white' });
        $('.productosColor8').css({ 'background-color': 'white' });
        $('.productosColor9').css({ 'background-color': 'white' });
        $('.productosColor10').css({ 'background-color': 'white' });
        $('.productosColor11').css({ 'background-color': 'white' });
        $('.productosColor12').css({ 'background-color': 'white' });
        $('.productosColor13').css({ 'background-color': 'white' });
        $('.productosColor229').css({ 'background-color': 'white' });
    ...
    public open(producto, productoNombre) {
        ...
        if (arrayComprobar[producto] == undefined) {
            ...
            if (producto == 1) {
                arrayComprobar[2] = undefined;
                arrayComprobar[3] = undefined;
                arrayComprobar[4] = undefined;
                arrayComprobar[5] = undefined;
                arrayComprobar[7] = undefined;
                arrayComprobar[6] = undefined;
                arrayComprobar[8] = undefined;
                arrayComprobar[9] = undefined;
                arrayComprobar[10] = undefined;
                arrayComprobar[11] = undefined;
                arrayComprobar[12] = undefined;
                arrayComprobar[13] = undefined;
                arrayComprobar[229] = undefined;
            }
            if (producto == 2) {
                arrayComprobar[3] = undefined;
                arrayComprobar[4] = undefined;
            ...
            if (producto == 1 || producto == 2) {
                $('.productosColor1').css({ 'margin-bottom': '650px' });
                $('.productosColor2').css({ 'margin-bottom': '650px' });
            }
            if (producto == 3 || producto == 4) {
                $('.productosColor3').css({ 'margin-bottom': '650px' });
                $('.productosColor4').css({ 'margin-bottom': '650px' });
            }
            if (producto == 5 || producto == 6) {
                $('.productosColor5').css({ 'margin-bottom': '650px' });
                $('.productosColor6').css({ 'margin-bottom': '650px' });
            }
            if (producto == 7 || producto == 8) {
                $('.productosColor7').css({ 'margin-bottom': '650px' });
                $('.productosColor8').css({ 'margin-bottom': '650px' });
            }
            if (producto == 9) {
                $('.productosColor9').css({ 'margin-bottom': '650px' });
            }
            if (producto == 229) {
                $('.productosColor9').css({ 'margin-bottom': '650px' });
            }
            if (producto == 10 || producto == 11) {
                $('.productosColor10').css({ 'margin-bottom': '650px' });
                $('.productosColor11').css({ 'margin-bottom': '650px' });
            }
            if (producto == 12 || producto == 13) {
                $('.productosColor12').css({ 'margin-bottom': '650px' });
                $('.productosColor13').css({ 'margin-bottom': '650px' });
            }
    ...
    public dimensionesCogidas(id) {
        ...
        if (acaSi == 0) {
            ...
            if (idProd1 == 1 || idProd1 == 2) {
                $('.productosColor1').css({ 'margin-bottom': '1200px' });
                $('.productosColor2').css({ 'margin-bottom': '1200px' });
            }
            if (idProd1 == 3 || idProd1 == 4) {
                $('.productosColor3').css({ 'margin-bottom': '1200px' });
                $('.productosColor4').css({ 'margin-bottom': '1200px' });
            }
            if (idProd1 == 5 || idProd1 == 6) {
                $('.productosColor5').css({ 'margin-bottom': '1200px' });
                $('.productosColor6').css({ 'margin-bottom': '1200px' });
            }
            if (idProd1 == 7 || idProd1 == 8) {
                $('.productosColor7').css({ 'margin-bottom': '1200px' });
                $('.productosColor8').css({ 'margin-bottom': '1200px' });
            }
            if (idProd1 == 9) {
                $('.productosColor9').css({ 'margin-bottom': '1200px' });
            }
            if (idProd1 == 229) {
                $('.productosColor9').css({ 'margin-bottom': '1200px' });
            }
            if (idProd1 == 10 || idProd1 == 11) {
                $('.productosColor10').css({ 'margin-bottom': '1200px' });
                $('.productosColor11').css({ 'margin-bottom': '1200px' });
            }
            if (idProd1 == 12 || idProd1 == 13) {
                $('.productosColor12').css({ 'margin-bottom': '1200px' });
                $('.productosColor13').css({ 'margin-bottom': '1200px' });
            }
    ...
    loadAll() {
        ...
        if (todos != undefined) {
            ...
            this.productosDormitorioService.categoria(1).subscribe(data => {
    ...
    ngOnInit() {
        ...
        this.precioTiendaProductosService.findProdId(1, tienda.id).subscribe(data => {
