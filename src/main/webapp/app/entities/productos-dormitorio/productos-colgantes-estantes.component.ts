...
@Component({
    ...
    templateUrl: './productos-colgantes-estantes.component.html'
})
export class ProductosColgantesEstantesComponent implements OnInit, OnDestroy {
    currentAccount: any;
    ...
    public borrarProdCalculadora() {
        ...
        $('.productosColor177').css({ 'background-color': 'white' });
        $('.productosColor178').css({ 'background-color': 'white' });
        $('.productosColor179').css({ 'background-color': 'white' });

        $('.productosColor177 #acabados').css({ display: 'none' });
        $('.productosColor178 #acabados').css({ display: 'none' });
        $('.productosColor179 #acabados').css({ display: 'none' });

        $('.productosColor177 #dimensiones').css({ display: 'none' });
        $('.productosColor178 #dimensiones').css({ display: 'none' });
        $('.productosColor179 #dimensiones').css({ display: 'none' });
        ...
        $('.productosColor177').removeAttr('style');
        $('.productosColor178').removeAttr('style');
        $('.productosColor179').removeAttr('style');

        $('.productosColorSolo177').removeAttr('style');
        $('.productosColorSolo178').removeAttr('style');
        $('.productosColorSolo179').removeAttr('style');
    ...
    public open(producto, productoNombre) {
        ...
        if (arrayComprobar[producto] == undefined) {
            ...
            if (producto == 177) {
                arrayComprobar[178] = undefined;
                arrayComprobar[179] = undefined;
            }
            if (producto == 178) {
                arrayComprobar[177] = undefined;
                arrayComprobar[179] = undefined;
            }
            if (producto == 179) {
                arrayComprobar[177] = undefined;
            ...
            if (producto == 177) {
                $('.productosColor177').css({ 'margin-bottom': '650px' });
            }
            if (producto == 178) {
                $('.productosColor178').css({ 'margin-bottom': '650px' });
            }
            if (producto == 179) {
                $('.productosColor179').css({ 'margin-bottom': '650px' });
            }
    ...
    public dimensionesCogidas(id) {
        ...
        if (acaSi == 0) {
            ...
            if (idProd1 == 177) {
                $('.productosColor177').css({ 'margin-bottom': '1130px' });
            }
            if (idProd1 == 178) {
                $('.productosColor178').css({ 'margin-bottom': '1130px' });
            }
            if (idProd1 == 179) {
                $('.productosColor179').css({ 'margin-bottom': '1130px' });
            }
    ...
    loadAll() {
        ...
        if (todos != undefined) {
            ...
            this.productosDormitorioService.categoria(15).subscribe(data => {
