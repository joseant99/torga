...
@Component({
    selector: 'jhi-categorias-dormi-formulario',
    templateUrl: './categorias-dormi-formulario.component.html'
})
export class CategoriasDormiFormularioComponent implements OnInit, OnDestroy {
    currentAccount: any;
    ...
    loadAll() {
        this.categoriasDormiService
            ...
            .subscribe(
                (res: HttpResponse<ICategoriasDormi[]>) => this.paginateCategoriasDormis(res.body, res.headers),
    ...
    protected paginateCategoriasDormis(data: ICategoriasDormi[], headers: HttpHeaders) {
        this.links = this.parseLinks.parse(headers.get('link'));
        this.totalItems = parseInt(headers.get('X-Total-Count'), 10);
        this.queryCount = this.totalItems;
        this.categoriasDormis = data;
    }
