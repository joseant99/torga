...
@Component({
    selector: 'jhi-productos-presupuesto-pedidos',
    templateUrl: './productos-presupuesto-pedidos.component.html'
})
export class ProductosPresupuestoPedidosComponent implements OnInit, OnDestroy {
    currentAccount: any;
    ...
    loadAll() {
        this.productosPresupuestoPedidosService
            ...
            .subscribe(
                (res: HttpResponse<IProductosPresupuestoPedidos[]>) => this.paginateProductosPresupuestoPedidos(res.body, res.headers),
