            ...
            (res: HttpResponse<IProductosPresupuestoPedidos[]>) => {
                ...
                for (let w = 0; w < productos.length; w++) {
                    if (
                        ...
                        this.acabadosProductosPresupuestoPedidoService.query1(productos[w]['id']).subscribe(data => {
                            var res = data;
                            acaComprobar = 0;
                            for (let i = 0; i < res.body.length; i++) {
                                ...
                                if (acaComprobar == 0) {
                                    if (productos != undefined) {
                                        ...
                                        for (let k = 0; k < acabados.length; k++) {
                                            ...
                                            var prodNombre = acabados[k]['productosPresupuestoPedidos']['productosDormitorio']['nombre'];
