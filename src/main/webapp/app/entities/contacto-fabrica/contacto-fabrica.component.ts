...
@Component({
    ...
    templateUrl: './contacto-fabrica.component.html'
})
export class ContactoFabricaComponent implements OnInit, OnDestroy {
    currentAccount: any;
    ...
    loadAll() {
        this.contactoFabricaService
            ...
            .subscribe(
                (res: HttpResponse<IContactoFabrica[]>) => this.paginateContactoFabricas(res.body, res.headers),
